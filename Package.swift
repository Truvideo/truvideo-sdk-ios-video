...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TruvideoSdkVideo",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-video/releases/download/76.1.1-RC.58/TruvideoSdkVideo.xcframework.zip",
            checksum: "6fcaa9f8d3993ab615d60e20a467527c6da54175dd65ffb3f21b4856a000d9c8"
        ),
        .target(
