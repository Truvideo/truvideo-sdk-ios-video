...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TruvideoSdkVideo",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-video/releases/download/75.1.2-BETA.54/TruvideoSdkVideo.xcframework.zip",
            checksum: "d6372670ea415f1ac6d09ff39920cd3a68bc60518eb861cc429cdb710a024f7f"
        ),
        .target(
