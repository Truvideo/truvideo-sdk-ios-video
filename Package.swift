...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TruvideoSdkVideo",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-video/releases/download/73.1.2/TruvideoSdkVideo.xcframework.zip",
            checksum: "15ed7ee3501fd4e5ea53c8a029766c769cbbd2f4a610fede8b8f11e1d0de463e"
        ),
        .target(
