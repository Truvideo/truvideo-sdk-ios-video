...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TruvideoSdkVideo",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-video/releases/download/75.1.2-DEV.53/TruvideoSdkVideo.xcframework.zip",
            checksum: "7bc36ff031d5a7ead714e8882ce5b8f0c154c35399c2a9a77f6235b9e63a89b1"
        ),
        .target(
