...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TruvideoSdkVideo",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-video/releases/download/76.1.1-BETA.56/TruvideoSdkVideo.xcframework.zip",
            checksum: "d4d70747a762d20d3591b527d3ec4e5cdec21df8751c4bd250967303d666105b"
        ),
        .target(
