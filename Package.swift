...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TruvideoSdkVideo",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-video/releases/download/75.1.1-RC.46/TruvideoSdkVideo.xcframework.zip",
            checksum: "5a29ffcc3caa765216470d68b0da652fb38a14ee20b4915abac0d649d9f13341"
        ),
        .target(
