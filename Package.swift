...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TruvideoSdkVideo",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-video/releases/download/75.1.2-BETA.52/TruvideoSdkVideo.xcframework.zip",
            checksum: "2510358fc5b249532d48e73996e3ee6e73498ac71b4054ea2d3fbffe242e4a67"
        ),
        .target(
