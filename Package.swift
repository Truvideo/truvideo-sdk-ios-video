...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TruvideoSdkVideo",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-video/releases/download/75.1.2-DEV.48/TruvideoSdkVideo.xcframework.zip",
            checksum: "76f9cc55d2efcef3fcaea2c60536cc4684189db01b12f039347107e554b93a60"
        ),
        .target(
