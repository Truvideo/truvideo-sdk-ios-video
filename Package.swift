...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TruvideoSdkVideo",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-video/releases/download/75.1.2-BETA.49/TruvideoSdkVideo.xcframework.zip",
            checksum: "a28042960c2105eeeb9988b77de669141637bf5c2cf2508c049954581ba90758"
        ),
        .target(
