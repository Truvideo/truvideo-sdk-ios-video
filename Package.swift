...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TruvideoSdkVideo",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-video/releases/download/75.1.2-RC.51/TruvideoSdkVideo.xcframework.zip",
            checksum: "5b26c25e395e9e4111ab3c791bc370e5d6103e7d51d1c373b2f20fc73aaecc4c"
        ),
        .target(
