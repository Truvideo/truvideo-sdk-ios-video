...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TruvideoSdkVideo",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-video/releases/download/76.1.1-DEV.57/TruvideoSdkVideo.xcframework.zip",
            checksum: "a255f4889c6ecc063792b26afec4d8fbac2f15c8ccdeaed6bf81cfafb02e44bc"
        ),
        .target(
