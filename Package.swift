...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TruvideoSdkVideo",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-video/releases/download/75.1.2-RC.55/TruvideoSdkVideo.xcframework.zip",
            checksum: "0d7c1eafb231e64e5f8926699ade34f9b90f171cd7e5efdd0d4fcdcb608418d1"
        ),
        .target(
