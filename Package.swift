...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TruvideoSdkVideo",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-video/releases/download/75.1.2-RC.50/TruvideoSdkVideo.xcframework.zip",
            checksum: "c8ab474b5b2ab5f03b9dd1f90c33bd1dc47ad2bbde1614d98faae815499f50f6"
        ),
        .target(
