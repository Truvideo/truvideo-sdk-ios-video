...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "TruvideoSdkVideo",
            url: "https://github.com/Truvideo/truvideo-sdk-ios-video/releases/download/75.1.1-BETA.44/TruvideoSdkVideo.xcframework.zip",
            checksum: "f4bafaa198f9b2a894327b173a247bcc81bb340313a5ab97b4f11faf014ed9aa"
        ),
        .target(
